drawImage <- function( xlabname, ylabname, mainname, color_mat, xMax, xMin, yMax, yMin, axis_leg ){
  ...
  image.plot( color_mat, zlim=c(0,1), xaxt="n", yaxt="n",
...
###--- main ---###
make_color_map <- function( color_mat, fname, xlabname, ylabname, x1, Sx1, Sx2, Sl1, Sl2,
